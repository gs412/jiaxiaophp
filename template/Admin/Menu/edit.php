			...
			<form method="post">
				<table class="table1">
					<tr>
						<td>上级分类：</td>
						<td>
							<select name="parent_id" id="parent_id" data-value="<?= $menu->parent_id ?>">
					...
					<tr>
						<td>菜单名称：</td>
						<td><input type="text" name="name" required="" value="<?= $menu->name ?>"></td>
					</tr>
					<tr style="display:none;">
						<td>控制器：</td>
						<td>
							<select name="controller" id="controller" data-value="<?= $menu->controller ?>">
					...
					<tr style="display:none;">
						<td>视图：</td>
						<td>
							<select name="action" id="action" data-value="<?= $menu->action ?>"></select>
						</td>
					</tr>
					<tr>
						<td>排序：</td>
						<td><input type="text" name="sort" style="width:50px;" value="<?= $menu->sort ?>"></td>
					</tr>
					<tr>
						<td></td>
						<td>
